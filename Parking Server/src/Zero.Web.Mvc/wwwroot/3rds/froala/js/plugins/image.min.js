...
!function (e, t) {
    ...
    Le = Le && Le.hasOwnProperty("default") ? Le["default"] : Le, Object.assign(Le.POPUP_TEMPLATES, {
        ...
        var C, l, p, f, s, a, S = A.$, E = "https://i.froala.com/upload", t = !1, i = 1, c = 2, d = 3, m = 4, R = 5,
            U = 6, n = {};
        ...
        function v(e) {
            void 0 === e && (e = !0);
            var t, a = Array.prototype.slice.call(A.el.querySelectorAll("img")), i = [];
        ...
        function D() {
            if (l || function o() {
                ...
                A.events.on("shared.destroy", function () {
                    ...
                    C && !C.hasClass("fr-uploading") ? fe(!0) : C && (D(), ve(), I(!1))
                });
                if (A.opts.imageResize) {
                    e = l.get(0).ownerDocument, A.events.$on(l, A._mousedown, ".fr-handler", w), A.events.$on(S(e), A._mousemove, x), A.events.$on(S(e.defaultView || e.parentWindow), A._mouseup, T), A.events.$on(f, "mouseleave", T);
                    var i = 1, n = null, r = 0;
        ...
        function w(e) {
            ...
            if ("mousedown" == e.type) {
                var a = A.$oel.get(0).ownerDocument, i = a.defaultView || a.parentWindow, n = !1;
                try {
        ...
        function x(e) {
            ...
            if (p && C) {
                ...
                if (!a) return !1;
                var i = a - p.data("start-x"), n = p.data("start-width");
                ...
                D(), A.events.trigger("image.resize", [ye()])
            }
        }
        ...
        function T(e) {
            ...
            if (p && C) {
                ...
                p = null, f.hide(), D(), r(), A.undo.saveStep(), A.events.trigger("image.resizeEnd", [ye()])
        ...
        function _(e, t, a) {
            ...
            var i = this.status, n = this.response, r = this.responseXML, o = this.responseText;
            try {
                if (A.opts.imageUploadToS3 || A.opts.imageUploadToAzure) if (201 == i) {
                    var s;
                    if (A.opts.imageUploadToAzure) {
                        ...
                        try {
                            var t = S(e).find("Location").text(), a = S(e).find("Key").text();
                    ...
                    s && L(s, !1, [], e, n || r)
                } else $(m, n || r, e); else if (200 <= i && i < 300) {
                    var l = function f(e) {
                        try {
        ...
        function Y(e, t, a) {
            ...
            if (t && void 0 !== t) for (i in t) t.hasOwnProperty(i) && "link" != i && (" data-".concat(i, '="').concat(t[i], '"'), n.attr("".concat(i), t[i]));
        ...
        function W(e, t) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if (A.drag_support.formdata && (a = A.drag_support.formdata ? new FormData : null), a) {
                    ...
                    var r, o, s = A.opts.imageUploadURL, l = A.opts.imageUploadMethod;
                    ...
                    if (A.opts.imageUploadToAzure) {
                        ...
                        if (!A.opts.imageUploadToAzure.SASToken && A.opts.imageUploadToAzure.accessKey) {
                            var g = A.opts.imageUploadToAzure.account, c = A.opts.imageUploadToAzure.container;
                    ...
                    !function w(t, a, i, n, r, o) {
                        function s() {
                            var e = S(this);
                            e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), A.placeholder.refresh(), O(e), D(), I(), A.edit.off(), t.onload = function () {
                                _.call(t, e, r, o)
        ...
        function X(e) {
            ...
            var r = A.opts.imageInsertButtons.indexOf("imageUpload"),
                o = A.opts.imageInsertButtons.indexOf("imageByURL"), s = "";
        ...
        function J() {
            var e = A.popups.get("image.size"), t = C.get(0).style.height ? C.get(0).style.height : "auto",
        ...
        function ee(e, t, a, i) {
            return e.pageX = t, w.call(this, e), e.pageX = e.pageX + a * Math.floor(Math.pow(1.1, i)), x.call(this, e), T.call(this, e), ++i
        }
        ...
        function ne(e) {
            ...
            C = S(e), D(), r(), ve(), I(), C.on("load", function () {
                var t = [];
                D(), S(A.popups.get("image.insert").get(0)).find("div.fr-active.fr-error").length < 1 && I(), S(this).data("events").find(function (e) {
                    "load" === e[0] && t.push(e)
            ...
            A.opts.imagePaste ? A.$el.find("img[data-fr-image-pasted]").each(function (e, i) {
                ...
                if (0 === i.src.indexOf("data:")) ne(i); else if (0 === i.src.indexOf("blob:") || 0 === i.src.indexOf("http") && A.opts.imageUploadRemoteUrls && A.opts.imageCORSProxy) {
                    ...
                    a.crossOrigin = "Anonymous", a.onload = function () {
                        var e, t = A.o_doc.createElement("CANVAS"), a = t.getContext("2d");
        ...
        function oe(e) {
            var t = e.target.result, a = A.opts.imageDefaultWidth;
        ...
        function me(e, t, a) {
            !A.opts.htmlUntouched && A.opts.useClasses ? (e.removeClass("fr-fil fr-fir fr-dib fr-dii"), a && e.addClass("fr-fi".concat(a[0])), t && e.addClass("fr-di".concat(t[0])), A.opts.imageDefaultMargin && e.css({margin: A.opts.imageDefaultMargin})) : "inline" == t ? (e.css({
        ...
        return {
                ...
                (function e() {
                    A.events.$on(A.$el, A._mousedown, "IMG" == A.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
                        ...
                        if (e.shiftKey && "" === A.selection.text().replace(/\n/g, "") && A.keys.isArrow(e.which)) {
                            var t = A.selection.element(), a = A.selection.endElement();
                    ...
                    for (var e = 0; e < i.length; e++) {
                        var t = i[e].style.width || S(i[e]).width(), a = i[e].style.height || S(i[e]).height();
            ...
            showInsertPopup: function Ee() {
                var e = A.$tb.find('.fr-command[data-cmd="insertImage"]'), t = A.popups.get("image.insert");
                if (t || (t = X()), z(), !t.hasClass("fr-active")) if (A.popups.refresh("image.insert"), A.popups.setContainer("image.insert", A.$tb), e.isVisible()) {
                    var a = A.button.getPosition(e), i = a.left, n = a.top;
            ...
            align: function Te(e) {
                var t = we();
                t.removeClass("fr-fir fr-fil"), !A.opts.htmlUntouched && A.opts.useClasses ? "left" == e ? t.addClass("fr-fil") : "right" == e && t.addClass("fr-fir") : me(t, he(), e), be(), D(), r(), A.selection.clear()
            },
            ...
            display: function Ie(e) {
                var t = we();
                t.removeClass("fr-dii fr-dib"), !A.opts.htmlUntouched && A.opts.useClasses ? "inline" == e ? t.addClass("fr-dii") : "block" == e && t.addClass("fr-dib") : me(t, e, ue()), be(), D(), r(), A.selection.clear()
            },
            ...
            toggleCaption: function Ne() {
                ...
                if (C && !Ae()) {
                    ...
                    if (0 < i.length) {
                        var n = i.find("li").length, r = C.parents("li"), o = document.createElement("li");
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Le.COMMANDS.imageAlign.options;
    ...
    }), Le.DefineIcon("imageAlt", {NAME: "info", SVG_KEY: "imageAltText"}), Le.RegisterCommand("imageAlt", {
        undo: !1,
        focus: !1,
        popup: !0,
