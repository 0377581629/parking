...
!function (e, t) {
    ...
    ye = ye && ye.hasOwnProperty("default") ? ye["default"] : ye, Object.assign(ye.POPUP_TEMPLATES, {
        ...
        var s, f, p, E, i, o, A = w.$, C = "https://i.froala.com/upload", v = 2, c = 3, u = 4, S = 5, U = 6, r = {};
        ...
        function a() {
            ...
            if (e || (e = function n() {
                ...
                var t = E.find("iframe, embed, ".concat(E.find("iframe, embed, audio").get(0) ? "audio" : "video")),
                    o = t.offset().left + t.outerWidth() / 2, i = t.offset().top + t.outerHeight(),
        ...
        function n(e) {
            ...
            var i, r = "", a = w.opts.videoInsertButtons.indexOf("videoUpload"),
        ...
        function _(e, t, o) {
            m("Loading video");
            var i = this.status, r = this.response, a = this.responseXML, n = this.responseText;
            try {
                if (w.opts.videoUploadToS3 || w.opts.videoUploadToAzure) if (201 == i) {
                    var s;
                    if (w.opts.videoUploadToAzure) {
                        ...
                        try {
                            var t = A(e).find("Location").text(), o = A(e).find("Key").text();
                    ...
                    s && x(s, !1, [], e, r || a)
                } else K(u, r || a); else if (200 <= i && i < 300) {
                    var d = function f(e) {
                        try {
        ...
        function I(e) {
            ...
            if (!t || !o) return !1;
            if ("mousedown" == e.type) {
                var i = w.$oel.get(0).ownerDocument, r = i.defaultView || i.parentWindow, a = !1;
                try {
        ...
        function L() {
            var e, t = Array.prototype.slice.call(w.el.querySelectorAll("video, .fr-video > *")), o = [];
        ...
        function O() {
            p || function n() {
                ...
                if (w.shared.$video_resizer ? (p = w.shared.$video_resizer, s = w.shared.$vid_overlay, w.events.on("destroy", function () {
                    ...
                    w.events.on("keydown", function (e) {
                        if (E) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey, o = e.which;
            ...
            var e = E.find("iframe, embed, ".concat(E.find("iframe, embed, audio").get(0) ? "audio" : "video")), t = 0,
                o = 0;
            ...
            if (void 0 !== e && 0 < e.length) {
                ...
                if (!(null !== w.opts.videoUploadURL && w.opts.videoUploadURL != C || w.opts.videoUploadToS3 || w.opts.videoUploadToAzure)) return function y(i) {
                    ...
                    r.onload = function () {
                        ...
                        x(window.URL.createObjectURL(new Blob([new Uint8Array(t)], {type: i.type})), !1, null, E)
                    }, R(), r.readAsDataURL(i)
                }(o), !1;
                ...
                if (w.drag_support.formdata && (t = w.drag_support.formdata ? new FormData : null), t) {
                    ...
                    if (w.opts.videoUploadToAzure) {
                        ...
                        if (!w.opts.videoUploadToAzure.SASToken && w.opts.videoUploadToAzure.accessKey) {
                            var f = w.opts.videoUploadToAzure.account, p = w.opts.videoUploadToAzure.container;
        ...
        function J(e, t, o) {
            !w.opts.htmlUntouched && w.opts.useClasses ? (e.removeClass("fr-fvl fr-fvr fr-dvb fr-dvi"), e.addClass("fr-fv".concat(o[0], " fr-dv").concat(t[0]))) : "inline" == t ? (e.css({display: "inline-block"}), "center" == o ? e.css({"float": "none"}) : "left" == o ? e.css({"float": "left"}) : e.css({"float": "right"})) : (e.css({
                display: "block",
                clear: "both"
        ...
        return r[1] = "Video cannot be loaded from the passed link.", r[v] = "No link in upload response.", r[c] = "Error during file upload.", r[u] = "Parsing response failed.", r[S] = "File is too large.", r[U] = "Video file type is invalid.", r[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", w.shared.vid_exit_flag = !1, {
            _init: function te() {
                ...
                var e = w.$tb.find('.fr-command[data-cmd="insertVideo"]'), t = w.popups.get("video.insert");
                if (t || (t = n()), l(), !t.hasClass("fr-active")) if (w.popups.refresh("video.insert"), w.popups.setContainer("video.insert", w.$tb), e.isVisible()) {
                    var o = w.button.getPosition(e), i = o.left, r = o.top;
            ...
            }, upload: H, insertByURL: function se(e) {
                ...
                if (/^http/.test(e) || (e = "https://".concat(e)), w.helpers.isURL(e)) for (var i = 0; i < ye.VIDEO_PROVIDERS.length; i++) {
                    var r = ye.VIDEO_PROVIDERS[i], a = "autoplay=1";
            ...
            }, remove: W, hideProgressBar: l, showSizePopup: function ue() {
                var e = w.popups.get("video.size");
                e || (e = X()), l(), w.popups.refresh("video.size"), w.popups.setContainer("video.size", w.$sc);
                var t = E.find("iframe, embed, ".concat(E.find("iframe, embed, audio").get(0) ? "audio" : "video")),
                    o = t.offset().left + t.outerWidth() / 2, i = t.offset().top + t.height();
                ...
                var t = E.offset().left + E.outerWidth() / 2, o = E.offset().top + E.height();
                ...
                return E
            }, showProgressBar: R, _editVideo: y, setAutoplay: function be() {
                var e;
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = ye.COMMANDS.videoAlign.options;
    ...
    }), ye.DefineIcon("autoplay", {NAME: "autoplay", SVG_KEY: "autoplay"}), ye.RegisterCommand("autoplay", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Autoplay",
