...
!function (e, a) {
    ...
    if ($ = $ && $.hasOwnProperty("default") ? $["default"] : $, Object.assign($.DEFAULTS, {
        ...
        var g, l, i, o, d, m, c, f, u, p, h, v = s.$, M = "image_manager", e = 10, b = 11, w = 12, C = 13, L = 14,
            D = 15, t = 21, r = 22, n = {};
        ...
        function x(e) {
            var a = v(e.currentTarget).siblings("img"), t = g.data("instance") || s, r = g.data("current-image");
            if (s.modals.hide(M), t.image.showProgressBar(), r) r.data("fr-old-src", r.attr("src")), r.trigger("click"); else {
                t.events.focus(!0), t.selection.restore();
                var n = t.position.getBoundingRect(), i = n.left + n.width / 2 + v(s.doc).scrollLeft(),
        ...
        function H(e) {
            ...
            confirm(a) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [i]) && (i.parent().addClass("fr-image-deleting"), v(this).ajax({
                ...
                headers: s.opts.requestHeaders,
                    ...
                    i.parent().remove(), E(r), function n() {
        ...
        function q() {
            var e = l.find(".fr-modal-head-line").outerHeight(), a = m.outerHeight();
        ...
        return n[e] = "Image cannot be loaded from the passed link.", n[b] = "Error during load images request.", n[w] = "Missing imageManagerLoadURL option.", n[C] = "Parsing load response failed.", n[L] = "Missing image thumb.", n[D] = "Missing image URL.", n[t] = "Error during delete image request.", n[r] = "Missing imageManagerDeleteURL option.", {
            require: ["image"], _init: function z() {
                ...
                if (!g) {
                    var e,
                        a = '<button class="fr-command fr-btn fr-modal-more fr-not-available" id="fr-modal-more-'.concat(s.sid, '"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24""><path d="').concat($.SVG.tags, '"/></svg></button><h4 data-text="true">').concat(s.language.translate("Manage Images"), '</h4></div>\n      <div class="fr-modal-tags" id="fr-modal-tags">');
    ...
    $.DEFAULTS.imageInsertButtons.push("imageManager"), $.RegisterCommand("imageManager", {
        ...
        NAME: "plus",
        SVG_KEY: "add"
    }), $.DefineIcon("imageManagerDelete", {NAME: "trash", SVG_KEY: "remove"})
});