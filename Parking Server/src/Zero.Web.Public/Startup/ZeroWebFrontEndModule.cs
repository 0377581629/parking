...
namespace Zero.Web.Public.Startup
{
    ...
    public class ZeroWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ZeroWebFrontEndModule(IWebHostEnvironment env, ZeroEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ZeroWebFrontEndModule).GetAssembly());
        }
    }
}
