...
using Zero.MultiTenancy.HostDashboard;
...
namespace Zero.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ZeroDbContext context, SubscriptionPayment subscriptionPayment)
        {
