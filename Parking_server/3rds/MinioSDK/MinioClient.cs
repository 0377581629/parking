...
namespace Minio
{
    public partial class MinioClient
    {
                                ...
                                object body = null, string resourcePath = null)
        {
            ...
            restClient.Authenticator = new V4Authenticator(Secure, AccessKey, SecretKey, region: Region, sessionToken: SessionToken);
        ...
        internal void InitClient()
        {
            ...
            authenticator = new V4Authenticator(Secure, AccessKey, SecretKey, Region, SessionToken);
        ...
        private async Task<IRestResponse> ExecuteTaskCoreAsync(IEnumerable<ApiResponseErrorHandlingDelegate> errorHandlers, IRestRequest request, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var response = await restClient.ExecuteTaskAsync(request, cancellationToken).ConfigureAwait(false);
