...
function fillScriptBundlesMetronic() {
...
function fillStyleBundlesMetronic() {
...
function fillScriptBundlesSimple() {
    // User defined bundles
    for (var k = 0; k < bundleConfig.scripts.length; k++) {
        var scriptBundle = bundleConfig.scripts[k];
        checkBundleItem(scriptBundle);
...
function fillStyleBundlesSimple() {
    // User defined styles
    for (var k = 0; k < bundleConfig.styles.length; k++) {
        var styleBundle = bundleConfig.styles[k];
        checkBundleItem(styleBundle);
...
function buildSimple() {
    fillScriptBundlesSimple();
    fillStyleBundlesSimple();
    fillScriptMappings();
    ...
    console.log('Bundles are being created simple, please wait...');

    return merge(scriptTasks.concat(styleTasks));
}

function buildMetronic() {
    fillScriptBundlesMetronic();
    fillStyleBundlesMetronic();
    fillScriptMappings();
...
exports.buildMetronic = buildMetronic;
