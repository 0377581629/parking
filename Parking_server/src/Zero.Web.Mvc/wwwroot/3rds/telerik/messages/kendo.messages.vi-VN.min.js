...
!function (e) {
    ...
    !function (e, n) {
        kendo.ui.FlatColorPicker && (kendo.ui.FlatColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, {
        ...
        })), kendo.ui.Groupable && (kendo.ui.Groupable.prototype.options.messages = e.extend(!0, kendo.ui.Groupable.prototype.options.messages, {empty: "Kéo tiêu đề cột và thả vào đây để nhóm lại bởi cột đó"})), kendo.ui.NumericTextBox && (kendo.ui.NumericTextBox.prototype.options = e.extend(!0, kendo.ui.NumericTextBox.prototype.options, {
            ...
            formatCellsDialog: {
                title: "Định dạng",
                categories: {number: "Số", currency: "Tiền tệ", date: "Ngày tháng"}
            },
            ...
            insertCommentDialog: {
                title: "Chèn ghi chú",
                labels: {comment: "Ghi chú", removeComment: "Loại bỏ ghi chú"}
            },
            insertImageDialog: {
                title: "Chèn ảnh",
