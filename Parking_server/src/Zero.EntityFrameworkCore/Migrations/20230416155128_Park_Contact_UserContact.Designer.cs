...
namespace Zero.Migrations
{
    ...
    [Migration("20230416155128_Park_Contact_UserContact")]
    partial class Park_Contact_UserContact
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DPS.Park.Core.Card.Card", b =>
                {
                    ...
                    b.ToTable("Park_Card_Card");
                });

            modelBuilder.Entity("DPS.Park.Core.Card.CardType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Park_Card_CardType");
                });

            modelBuilder.Entity("DPS.Park.Core.Contact.UserContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Park_Contact_UserContact");
                });

            modelBuilder.Entity("DPS.Park.Core.Fare.Fare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DPS.Park.Core.History.History", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Park_History");
                });

            modelBuilder.Entity("DPS.Park.Core.Message.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DPS.Park.Core.Order.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<long>("VnpTransactionNo")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DPS.Park.Core.Vehicle.VehicleType", b =>
                {
                    ...
                    b.ToTable("Park_Vehicle_VehicleType");
                });
            ...
            modelBuilder.Entity("DPS.Park.Core.Card.Card", b =>
                {
                    b.HasOne("DPS.Park.Core.Card.CardType", "CardType")
                        .WithMany()
                        .HasForeignKey("CardTypeId");

                    b.HasOne("DPS.Park.Core.Vehicle.VehicleType", "VehicleType")
                        .WithMany()
